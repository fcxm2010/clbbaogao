        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             <div className="bg-stone-800 p-6 rounded-2xl shadow-md text-white flex flex-col justify-center items-center text-center relative overflow-hidden group">
                 <img src="https://photo.7zi.top/2025/11/changlangbahangpai1.webp" className="absolute inset-0 w-full h-full object-cover opacity-20 group-hover:opacity-30 transition-opacity" alt="长浪坝航拍" />
